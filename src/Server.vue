<template>
  <div>
    <el-button v-if="account.admin" type="primary" size="medium" icon="el-icon-plus" @click="serverInfo = {}, addVisible = true" :loading="loading">添加转播服务器</el-button>
    <hr/>
      ...
      <el-table-column label="操作" width="160px">
        <template slot-scope="scope">
            <el-popover placement="bottom" width="200" :ref="`popover-${scope.$index}`">
              <p><i class="el-icon-warning"></i> 删除转播服务器后无法恢复, 是否继续?</p>
              <div style="text-align: right; margin-top:8px;">
                <el-button type="primary" size="mini" @click="removeServer(scope.$index, scope.row)">继续</el-button>
              </div>
    ...
    <el-dialog title="转播服务器新增" :visible.sync="addVisible" width="580px">
        ...
        <span slot="footer" class="dialog-footer">
            <el-button type="primary" size="medium" @click="addServer()">新 增</el-button>
        </span>
    </el-dialog>
  </div>
</template>
